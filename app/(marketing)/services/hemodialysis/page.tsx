        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-slate-600 mb-8">
              Experience dialysis reimagined. High-flux membranes, ultrapure
              water, and a serene environment designed to make your treatment
              time your own.
            </p>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="md:w-1/2">
              ...
              <p className="text-slate-300 text-lg mb-8">
                Four hours is a long time. We've designed our stations to be
                private suites where you can work, rest, or be entertained.
              </p>
              <ul className="space-y-4">
                {[
                  ...
                  {
                    icon: <MonitorPlay />,
                    text: "Personal Entertainment Systems",
                  },
            ...
            <div className="md:w-1/2">
              <div className="h-100 w-full bg-slate-800 rounded-2xl overflow-hidden relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <Image
                    src="/patientOnBed.jpg"
                    alt="Patient comfortably reclining with iPad"
                    fill
